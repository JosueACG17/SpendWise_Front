<template>
  ...
  <div class="container mx-auto p-3 sm:p-2 shadow-lg rounded-lg">
    <div class="bg-white">
      ...
      <div class="mt-5">
        <div class="flex items-center space-x-1 font-semibold text-gray-900">
          ...
          <span class="tracking-wide mb-2">Mi Información Personal</span>
        </div>
        <div class="text-gray-700">
          <div class="grid md:grid-cols-2 text-sm">
            <div class="grid grid-cols-2">
              <div class="px-4 py-2 font-semibold">Nombre Completo</div>
              <div class="px-4 py-2">Josue Chan Gutierrez</div>
            </div>
            <div class="grid grid-cols-2">
            ...
            <div class="grid grid-cols-2">
              <div class="px-4 py-2 font-semibold">Número Telefonico</div>
              <div class="px-4 py-2">9984847064</div>
            </div>
            <div class="grid grid-cols-2">
      ...
      <div class="flex justify-end mt-6">
        <button
          @click="openModal"
          class="bg-yellow-400 text-gray-900 font-semibold py-2 px-4 rounded-lg hover:bg-yellow-500 transition duration-300"
        >
          Editar Perfil
        </button>
      </div>
  ...
  <div v-if="isModalOpen" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
    <div class="bg-white p-6 rounded-lg w-full max-w-2xl">
      ...
      <div class="flex justify-end mt-6 space-x-4">
        <button
          @click="closeModal"
          class="bg-gray-300 text-gray-900 font-semibold py-2 px-4 rounded-lg hover:bg-gray-400 transition duration-300"
        >
          Cancelar
        </button>
        <button
