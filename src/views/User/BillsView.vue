            ...
            <div class="inputs">
              ...
              <v-card-actions>
                <div class="flex justify-end w-full">
                  <button class="mt-3 w-full inline-flex justify-center rounded-md cursor-pointer border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm" type="button"
                    @click="dialog = false">Cancelar</button>
                  <button class="w-full inline-flex justify-center rounded-md cursor-pointer border border-transparent shadow-sm px-4 py-2 bg-yellow-600 text-base font-medium text-white hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 sm:ml-3 sm:w-auto sm:text-sm" type="submit">Guardar</button>
                </div>
              </v-card-actions>
            </div>
          </Form>
