<template>
  <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
    <div
      class="border-b border-gray-200 bg-gray-50 px-6 py-5 flex flex-col md:flex-row md:items-center md:justify-between">
      <div>
      ...
      <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
        <div>
          <p class="text-sm text-gray-700">
            Mostrando <span class="font-medium">1</span> a <span class="font-medium">{{ filteredItems.length }}</span>
            de <span class="font-medium">{{ items.length }}</span> resultados
          </p>
        </div>
        <div>
